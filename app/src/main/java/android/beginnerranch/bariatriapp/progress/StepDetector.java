...
import android.beginnerranch.bariatriapp.services.SensorFilter;
...
public class StepDetector {
    ...
    private static final float STEP_THRESHOLD = 0.1f;
    ...
    public void updateAccel(long timeNs, float x, float y, float z) {
        ...
        if (velocityEstimate > STEP_THRESHOLD && oldVelocityEstimate <= STEP_THRESHOLD
                && (timeNs - lastStepTimeNs > STEP_DELAY_NS) && listener != null) {
